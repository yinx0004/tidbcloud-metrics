...
class MetricsAnalyzer:
    def __init__(self, request, resource_usage_metrics, capacity_metrics, plan_traffic_x, plan_resource_redundancy_x, log_file_name, log_level):
    ...
    def analyze(self):
        ...
        capacity, instance_cnt = self.get_capacity_n_count()
        data["capacity"] = capacity
        data["instance_cnt"] = instance_cnt

        plan = self.capacity_planner.get_resource_capacity_plan(instance_cnt, capacity)
